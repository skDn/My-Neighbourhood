...
public class Utils {
    ...
    public static final String MAP_API_KEY = "AIzaSyCMhrCAcq8smEzsDTRr3x0c06kQ9feAGzo";
    ...
    public static final String EXTRA_USER_ID_FOR_PROFILE_ACTIVITY = "extra_other_user";
}
